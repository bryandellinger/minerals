...
export default function initSuretyDataTable(data) {
    const table = $('#wellSuretyTable').DataTable(
    {
      data,
      dom: 'lBfrtip',
      orderCellsTop: true,
      ...
      buttons: [
            ...
            columns: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        if (type === 'display') {
                            data = '<a href="./Surety?container=addUpdateSuretyContainer&suretyId=' + row.id +'&wellId=' + row.wellId +'"><i class="fas fa-link"></i>' + data + '</a>';
                        }
                        return data;
                    }
                },
        ...
        {
            data: 'suretyWellValue',
            name: 'suretyWellValue',
                    autoWidth: true,
                    render: $.fn.dataTable.render.number(',', '.', 2),
         },
        {
